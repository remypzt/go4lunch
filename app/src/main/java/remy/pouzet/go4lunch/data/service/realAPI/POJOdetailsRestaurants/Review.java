...
public class Review {
	...
	@SerializedName("author_url") private                String mAuthorUrl;
	@SerializedName("language") private                  String mLanguage;
	@SerializedName("profile_photo_url") private         String mProfilePhotoUrl;
	@SerializedName("rating") private                    Long   mRating;
	@SerializedName("relative_time_description") private String mRelativeTimeDescription;
