...
public class MapViewFragment extends AppCompatActivity implements OnMapReadyCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Retrieve the content view that renders th
		// e map.
		setContentView(R.layout.fragment_map_view);
		
		// [START_EXCLUDE silent]
		// Construct a PlacesClient
		//	Places.initialize(getApplicationContext(), "AIzaSyAOzjIvFYJQuHab8tohRIs9-rCcd-Nvlwk");
				...
				public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
					if (task.isSuccessful() && task.getResult() != null) {
						...
						for (PlaceLikelihood placeLikelihood : likelyPlaces.getPlaceLikelihoods()) {
							...
							likelyPlaceNames[i]        = placeLikelihood
									.getPlace()
									.getName();
							likelyPlaceAddresses[i]    = placeLikelihood
									.getPlace()
									.getAddress();
							likelyPlaceAttributions[i] = placeLikelihood
									.getPlace()
									.getAttributions();
							likelyPlaceLatLngs[i]      = placeLikelihood
									.getPlace()
									.getLatLng();
